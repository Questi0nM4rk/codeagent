...
| Code Search | **MCP** | - | - | AST-based queries |
| Memory/Context | **MCP** | - | - | Requires structured API |
...
- Service requires structured queries (code-graph AST)
- No good CLI exists
...
- Querying code structure/AST
- Managing persistent memory/context
